...
assert_true(DingTimerMainWindow:IsShown(), "left-click should show the dashboard tab")
assert_eq(DingTimerDB.lastOpenTab, 1, "left-click should target the dashboard tab")

minimapClick(DingTimerMinimapButton, "LeftButton")
assert_true(not DingTimerMainWindow:IsShown(), "left-click on the active dashboard tab should hide the main window")

minimapClick(DingTimerMinimapButton, "MiddleButton")
assert_true(DingTimerMainWindow:IsShown(), "middle-click should show the graph tab")
assert_eq(DingTimerDB.lastOpenTab, 2, "middle-click should target the graph tab")
